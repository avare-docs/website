...
Again, it's easy and error-proof. At the top of that Edit window are options to switch between **Edit file** and **Preview** modes so you can see how your Contribution is going to look then switch back to Edit file mode to send it in.
